...
function LeftBar({
  ...
  return (
    <div className={`lg:grid lg:gap-2 lg:grid-flow-row lg:grid-cols-1 bg-opacity-10 border-r-slate-300 border-r-2 pt-52 px-2  hidden bg-slate-300 h-screen ${mode&&"text-white"}`} >
      {/* illustrationrelated */}
      <div className=''>
